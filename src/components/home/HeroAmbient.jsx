    ...
    const animate = () => {
      ...
      for (let row = 0; row < rows; row++) {
        for (let col = 0; col < cols; col++) {
          ...
          // Color based on intensity (fire-like gradient)
          let r, g, b;
          if (charIndex >= 5) {
            r = 229; g = 254; b = 87; // Hot lime
          } else if (charIndex >= 3) {
            r = 31; g = 201; b = 255; // Cyan
          } else if (charIndex >= 1) {
            r = 120; g = 160; b = 200; // Cool blue
          } else {
            r = 80; g = 100; b = 120; // Very dim
          }
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div 
        className="absolute inset-0"
        style={{
          background: 'radial-gradient(circle at center, transparent 30%, rgba(15, 16, 17, 0.4) 70%, #0f1011 100%)'
        }}
      />
    </div>
  );
