...
export default function JobDialog({ job, onClose }) {
  const typeColors = {
    ...
    "Contract": "bg-purple-100 text-purple-800 border-purple-300",
    "Internship": "bg-orange-100 text-orange-800 border-orange-300",
  };

  // Convert <br> tags to actual newlines for markdown
  ...
  // Get description from template or custom field
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Badge className={`${typeColors[job.job_type]} border`}>
              {job.job_type}
            </Badge>
            {job.salary_range && (
          ...
          {/* Job Details */}
          {displayContent ? (
            <div className="job-markdown text-gray-700">
              <ReactMarkdown
                components={{
                  ul: ({node, ...props}) => <ul style={{listStyleType: 'disc', paddingLeft: '2rem'}} {...props} />,
          ...
          {job.tags && job.tags.length > 0 && (
            <div>
              <h3 className="font-semibold text-gray-900 mb-3 text-lg">Skills & Technologies</h3>
